...
class InformalContentPage extends StatefulWidget {
  final int index;
  const InformalContentPage({Key? key, required this.index}) : super(key: key);

  @override
  State<InformalContentPage> createState() => _InformalContentPageState();
}

late WebViewController __controller;

class _InformalContentPageState extends State<InformalContentPage> {
  @override
  ...
  _loadHTML() async {
    String fileText = await rootBundle
        .loadString("assests/informalwebtext${widget.index}.html");
